...
import com.ai.mnt.model.collect.WsnDrift2;
...
/**
 * @Title: WsnDriftMapper 
 * @Description: WsnDriftMapper Persistence
 * @Author: Auto Generate. HE
 * @Date: 2016-12-21
 */
@Repository
public interface WsnDriftMapper2 extends CrudMapper<WsnDrift2, Integer>{

    List<WsnDrift> findList(@Param("wareId")String wareId,@Param("bDate") Date bDate, @Param("eDate")Date eDate);
