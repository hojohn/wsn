...
import com.ai.mnt.model.collect.WsnSmoke2;
...
/**
 * @Title: WsnSmokeMapper 
 * @Description: WsnSmokeMapper Persistence
 * @Author: Auto Generate. HE
 * @Date: 2016-12-21
 */
@Repository
public interface WsnSmokeMapper2 extends CrudMapper<WsnSmoke2, Integer>{

    List<WsnSmoke> findList(@Param("wareId")String wareId,@Param("bDate") Date bDate, @Param("eDate")Date eDate);
