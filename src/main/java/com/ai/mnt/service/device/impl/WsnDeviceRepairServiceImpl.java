...
public class WsnDeviceRepairServiceImpl implements WsnDeviceRepairService{
    ...
    public void saveWsnDeviceRepair(WsnDeviceRepair wsnDeviceRepair)
        ...
        //List<WsnDeviceRepair>repairs = wsnDeviceRepairMapper.findByRfid(wsnDeviceRepair.getDeviceRfid());
       /* if (repairs == null && repairs.size() <= 0) {
            throw new MntDataAccessException("输入的RFID编号不存在！" );
        }*/
       /* if (1 == 1) {
            throw new MntDataAccessException("输入的RFID编号不存在！" );
        }*/
   ...
   /* @Override
    public List<WsnDeviceRepair> findWsnDeviceRepairListByRfid(int deviceRfid) {
        List<WsnDeviceRepair> wsnDeviceRepairListByRfid1 = wsnDeviceRepairMapper.findByRfid(deviceRfid);
        return wsnDeviceRepairListByRfid1;
    }*/
