                        ...
                        <div class="row">
                            <div class="col-md-4">
                                <div class="form-group">
                                    <label class="control-label col-md-4">标签人员关联ID</label>
                                    <div class="col-md-8">
                                        <input type="text" class="form-control" id="rfEmpId">
                                    </div>
                                </div>
                            </div>
                            <div class="col-md-4">
                                <div class="form-group">
                                    <label class="control-label col-md-4">标签ID</label>
                                    <div class="col-md-8">
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    <label class="control-label col-md-4">人员ID</label>
                                    <div class="col-md-8">
...
<!--                     </div> -->
                    <div class="portlet-body">
                        <table class="table table-striped table-bordered table-hover table-checkable order-column" id="tabWsnEmpRfid" cellspacing="0" width="100%">
                            <thead>
                                <tr>
...
<script>
    $(function() {
        ...
        var tableObj = $('#tabWsnEmpRfid').DataTable(getConfig());
        $('#btnQuery').click(function(e) {
            var strRfEmpId = $("#rfEmpId").val();
            var strRfidId = $("#rfidId").val();
            var strPersonId = $("#personId").val();
        ...
        $('.reload').on('click', function() {
            ...
            $('#rfidId').val('');
            $('#personId').val('');
            tableObj.ajax.url('device/rfid/query?rfEmpId=-1').load();
        });
        
        //修改按钮
        $('.div_right').on('click', '.dt-buttons>#btnUpdate',function() {
            var checkedBox = $("#tabWsnEmpRfid tbody tr td .checked");
            ...
            var strRfEmpId = checkedBox.find('input:checkbox').val();
            showModal(2, " ", [ '1000px', '500px' ], "device/rfid/update_page/" + strRfEmpId, tableObj);
        });
    ...
    function getConfig() {
        return config = {
            ...
            "serverSide" : false,
            "ajax" : {
                "url" : "device/rfid/query?rfEmpId=-1"
            //    "async": false
            },
            "columns" : [ {
                "data" : "rfEmpId"
