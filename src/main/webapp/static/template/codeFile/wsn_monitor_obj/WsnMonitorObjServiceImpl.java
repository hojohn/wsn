...
public class WsnMonitorObjServiceImpl implements WsnMonitorObjService{
    ...
    public WsnMonitorObj findWsnMonitorObjByMonitorObjId(Integer monitorObjId) {
        WsnMonitorObj wsnMonitorObj = wsnMonitorObjMapper.findByPrimaryKey(monitorObjId);
        return wsnMonitorObj;
    }
    ...
    public void saveWsnMonitorObj(WsnMonitorObj wsnMonitorObj) {
        ...
        wsnMonitorObj.setDeleteFlag("0");
        wsnMonitorObj.setCreator(currentUser.getUserName());
        wsnMonitorObj.setModifier(currentUser.getUserName());
        wsnMonitorObj.setCreateDate(new Date());
