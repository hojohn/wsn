                    ...
                    <div class="row border-txt">
                        <div class="col-md-6">
                            <div class="form-group form-md-line-input">
                                ...
                                <div class="col-md-8">
                                    <p  class="form-control-static">${wsnHardwareInfo.typeId}</p>
                                </div>
                            </div>
                        </div>
                        <div class="col-md-6">
                    ...
                    <div class="row border-txt">
                        <div class="col-md-6">
                            <div class="form-group form-md-line-input">
                                ...
                                <div class="col-md-8">
                                    <p  class="form-control-static">${wsnHardwareInfo.updateTime}</p>
                                </div>
                            </div>
                        </div>
                        <div class="col-md-6">
                    ...
                    <div class="row border-txt">
                        ...
                        <div class="col-md-6">
                            <div class="form-group form-md-line-input">
                                ...
                                <div class="col-md-8">
                                    <p  class="form-control-static">${wsnHardwareInfo.remark2}</p>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="row border-txt">
                        <div class="col-md-6">
                            <div class="form-group form-md-line-input">
                                ...
                                <div class="col-md-8">
                                    <p  class="form-control-static">${wsnHardwareInfo.infoFive}</p>
                                </div>
                            </div>
                        </div>
                        <div class="col-md-6">
