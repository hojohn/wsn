                ...
                <form action="#" class="form-horizontal">
                    <div class="form-body">
                        <div class="row">
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    <label class="control-label col-md-4">传感器湿度值</label>
                                    <div class="col-md-8">
                                        <input type="text" class="form-control" id="humidityValue">
                                    </div>
                                </div>
                            </div>
                        </div>
...
<!--                     </div> -->
                    <div class="portlet-body">
                        <table class="table table-striped table-bordered table-hover table-checkable order-column" id="tabWsnHumidity" cellspacing="0" width="100%">
                            <thead>
                                <tr>
...
<script>
    $(function() {
        ...
        var tableObj = $('#tabWsnHumidity').DataTable(getConfig());
        $('#btnQuery').click(function(e) {
            var strWareId = $("#wareId").val();
            var strObjId = $("#objId").val();
            var strHumidityValue = $("#humidityValue").val();
            ...
            sUrl += 
                "&wareId=" + strWareId +
                "&objId=" + strObjId +
                "&humidityValue=" + strHumidityValue +
                "&rate=" + strRate +
                "&state=" + strState +
        ...
        $('.div_right').on('click', '.dt-buttons>#btnUpdate',function() {
            var checkedBox = $("#tabWsnHumidity tbody tr td .checked");
