                ...
                <form action="#" class="form-horizontal">
                    <div class="form-body">
                        <div class="row">
                            <div class="col-md-4">
                                <div class="form-group">
                                    <label class="control-label col-md-4">维修编号</label>
                                    <div class="col-md-8">
                                        <input type="text" class="form-control" id="repairId">
                                    </div>
                                </div>
                            </div>
                            <div class="col-md-4">
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    <label class="control-label col-md-4">维修信息</label>
                                    <div class="col-md-8">
                                        <input type="text" class="form-control" id="repairInfo">
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    <label class="control-label col-md-4">记录创建时间</label>
                                    <div class="col-md-8">
                                        <div class="input-group date-picker input-daterange" data-date="2012-12-12" data-date-format="yyyy-mm-dd">
                                            <input type="text" class="form-control" name="from" id="beginDate" readonly AUTOCOMPLETE="off">
                                            <span class="input-group-addon"> 到 </span>
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    <label class="control-label col-md-4">记录修改人</label>
                                    <div class="col-md-8">
                        ...
                        <div class="row">
                            <div class="col-md-4">
                                <div class="form-group">
                                    <label class="control-label col-md-4">记录修改时间</label>
                                    <div class="col-md-8">
                                        <div class="input-group date-picker input-daterange" data-date="2012-12-12" data-date-format="yyyy-mm-dd">
                                            <input type="text" class="form-control" name="from" id="beginDate" readonly AUTOCOMPLETE="off">
                                            <span class="input-group-addon"> 到 </span>
...
<script>
    $(function() {
        ...
        $('#btnQuery').click(function(e) {
            var strRepairId = $("#repairId").val();
            var strDeviceRfid = $("#deviceRfid").val();
            var strRepairInfo = $("#repairInfo").val();
            var strRepairTime = $("#repairTime").val();
            ...
            sUrl += 
                "&repairId=" + strRepairId +
                "&deviceRfid=" + strDeviceRfid +
                "&repairInfo=" + strRepairInfo +
                "&repairTime=" + strRepairTime +
