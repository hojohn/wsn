                        ...
                        <div class="row">
                            <div class="col-md-4">
                                <div class="form-group">
                                    <label class="control-label col-md-4">rfid主键</label>
                                    <div class="col-md-8">
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    <label class="control-label col-md-4">RFID标签序列号</label>
                                    <div class="col-md-8">
                                        <input type="text" class="form-control" id="rfidSequence">
                                    </div>
                                </div>
                            </div>
                            <div class="col-md-4">
                                <div class="form-group">
                                    <label class="control-label col-md-4">RFID绑定编号</label>
                                    <div class="col-md-8">
                                        <input type="text" class="form-control" id="rfidBindNumber">
                                    </div>
                                </div>
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <div class="col-md-8">
                                        <input type="text" class="form-control" id="rfidDesc">
                                    </div>
                                </div>
                            </div>
                            <div class="col-md-4">
                                <div class="form-group">
                                    <label class="control-label col-md-4">RFID类型，1人员，2设备</label>
                                    <div class="col-md-8">
                                        <input type="text" class="form-control" id="rfidType">
                                    </div>
                                </div>
                            </div>
                            <div class="col-md-4">
                                <div class="form-group">
                                    <label class="control-label col-md-4">删除标志，1删除，0未删除</label>
                                    <div class="col-md-8">
...
<!--                     </div> -->
                    <div class="portlet-body">
                        <table class="table table-striped table-bordered table-hover table-checkable order-column" id="tabWsnRfid" cellspacing="0" width="100%">
                            <thead>
                                <tr>
...
<script>
    $(function() {
        ...
        var tableObj = $('#tabWsnRfid').DataTable(getConfig());
        $('#btnQuery').click(function(e) {
            var strRfidId = $("#rfidId").val();
            var strRfidSequence = $("#rfidSequence").val();
            var strRfidBindNumber = $("#rfidBindNumber").val();
            var strRfidDesc = $("#rfidDesc").val();
            var strRfidType = $("#rfidType").val();
            ...
            var sUrl = "device/rfid/query?";
            sUrl += 
                "&rfidId=" + strRfidId +
                "&rfidSequence=" + strRfidSequence +
                "&rfidBindNumber=" + strRfidBindNumber +
                "&rfidDesc=" + strRfidDesc +
                "&rfidType=" + strRfidType +
        ...
        $('.reload').on('click', function() {
            ...
            $('#modifier').val('');
            $('#modifyDate').val('');
            tableObj.ajax.url('device/rfid/query?rfidId=-1').load();
        });
        
        //修改按钮
        $('.div_right').on('click', '.dt-buttons>#btnUpdate',function() {
            var checkedBox = $("#tabWsnRfid tbody tr td .checked");
            ...
            var strRfidId = checkedBox.find('input:checkbox').val();
            showModal(2, " ", [ '1000px', '500px' ], "device/rfid/update_page/" + strRfidId, tableObj);
        });
        
        //新增
        $('.div_right').on('click', '.dt-buttons>#btnAdd', function(){
            showModal(2, " ", ['1000px', '500px'], "device/rfid/add_page", tableObj);
        });
        
        //删除按钮
        $('.div_right').on('click', '.dt-buttons>#btnDelete',function() {
            var checkedBox = $("#tabWsnRfid tbody tr td .checked");
            comfirmDeleteData(tableObj, checkedBox, 'device/rfid/delete/');
        });
    ...
    function getConfig() {
        return config = {
            ...
            "serverSide" : false,
            "ajax" : {
                "url" : "device/rfid/query?rfidId=-1"
            //    "async": false
            },
            "columns" : [ {
                "data" : "rfidId"
