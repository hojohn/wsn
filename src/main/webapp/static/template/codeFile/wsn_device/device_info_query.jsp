                ...
                <form action="#" class="form-horizontal">
                    <div class="form-body">
                        ...
                        <div class="row">
                            <div class="col-md-4">
                                <div class="form-group">
                                    <label class="control-label col-md-4">设备编码</label>
                                    <div class="col-md-8">
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    <label class="control-label col-md-4">报废日期</label>
                                    <div class="col-md-8">
                                        <div class="input-group date-picker input-daterange" data-date="2012-12-12" data-date-format="yyyy-mm-dd">
                                            <input type="text" class="form-control" name="from" id="beginDate" readonly AUTOCOMPLETE="off">
                                            <span class="input-group-addon"> 到 </span>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    <label class="control-label col-md-4">设备描述</label>
                                    <div class="col-md-8">
...
<script>
    $(function() {
        ...
        $('#btnQuery').click(function(e) {
            ...
            var strDeviceType = $("#deviceType").val();
            var strDeviceName = $("#deviceName").val();
            var strDeviceNumber = $("#deviceNumber").val();
            var strInstDate = $("#instDate").val();
            var strScrapDate = $("#scrapDate").val();
            var strDeleteFlag = $("#deleteFlag").val();
            var strDeviceDesc = $("#deviceDesc").val();
            ...
            sUrl += 
                ...
                "&instDate=" + strInstDate +
                "&scrapDate=" + strScrapDate +
                "&deleteFlag=" + strDeleteFlag +
                "&deviceDesc=" + strDeviceDesc +
                "&creator=" + strCreator +
