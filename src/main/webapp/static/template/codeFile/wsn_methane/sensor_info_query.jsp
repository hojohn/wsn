                ...
                <form action="#" class="form-horizontal">
                    <div class="form-body">
                        <div class="row">
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    <label class="control-label col-md-4">传感器甲烷值</label>
                                    <div class="col-md-8">
                                        <input type="text" class="form-control" id="methaneValue">
                                    </div>
                                </div>
                            </div>
                        </div>
...
<!--                     </div> -->
                    <div class="portlet-body">
                        <table class="table table-striped table-bordered table-hover table-checkable order-column" id="tabWsnMethane" cellspacing="0" width="100%">
                            <thead>
                                <tr>
...
<script>
    $(function() {
        ...
        var tableObj = $('#tabWsnMethane').DataTable(getConfig());
        $('#btnQuery').click(function(e) {
            var strWareId = $("#wareId").val();
            var strObjId = $("#objId").val();
            var strMethaneValue = $("#methaneValue").val();
        ...
        $('.div_right').on('click', '.dt-buttons>#btnUpdate',function() {
            var checkedBox = $("#tabWsnMethane tbody tr td .checked");
