                        ...
                        <div class="row">
                            <div class="col-md-4">
                                <div class="form-group">
                                    <label class="control-label col-md-4">标签设备关联ID</label>
                                    <div class="col-md-8">
                                        <input type="text" class="form-control" id="rfDevId">
                                    </div>
                                </div>
                            </div>
                            <div class="col-md-4">
...
<!--                     </div> -->
                    <div class="portlet-body">
                        <table class="table table-striped table-bordered table-hover table-checkable order-column" id="tabWsnDevRfid" cellspacing="0" width="100%">
                            <thead>
                                <tr>
...
<script>
    $(function() {
        ...
        var tableObj = $('#tabWsnDevRfid').DataTable(getConfig());
        $('#btnQuery').click(function(e) {
            var strRfDevId = $("#rfDevId").val();
        ...
        $('.reload').on('click', function() {
            ...
            $('#rfidId').val('');
            $('#deviceId').val('');
            tableObj.ajax.url('device/rfid/query?rfDevId=-1').load();
        });
        
        //修改按钮
        $('.div_right').on('click', '.dt-buttons>#btnUpdate',function() {
            var checkedBox = $("#tabWsnDevRfid tbody tr td .checked");
            ...
            var strRfDevId = checkedBox.find('input:checkbox').val();
            showModal(2, " ", [ '1000px', '500px' ], "device/rfid/update_page/" + strRfDevId, tableObj);
        });
    ...
    function getConfig() {
        return config = {
            ...
            "serverSide" : false,
            "ajax" : {
                "url" : "device/rfid/query?rfDevId=-1"
            //    "async": false
            },
            "columns" : [ {
                "data" : "rfDevId"
