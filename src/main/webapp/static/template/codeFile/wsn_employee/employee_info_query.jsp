                ...
                <form action="#" class="form-horizontal">
                    <div class="form-body">
                        <div class="row">
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    <label class="control-label col-md-4">员工年龄</label>
                                    <div class="col-md-8">
                        ...
                        <div class="row">
                            <div class="col-md-4">
                                <div class="form-group">
                                    <label class="control-label col-md-4">员工性别，0男，1女</label>
                                    <div class="col-md-8">
                                        <input type="text" class="form-control" id="employeeGender">
                                    </div>
                                </div>
                            </div>
                            <div class="col-md-4">
                        ...
                        <div class="row">
                            <div class="col-md-4">
                                <div class="form-group">
                                    <label class="control-label col-md-4">参加工作时间</label>
                                    <div class="col-md-8">
                                        <div class="input-group date-picker input-daterange" data-date="2012-12-12" data-date-format="yyyy-mm-dd">
                                            <input type="text" class="form-control" name="from" id="beginDate" readonly AUTOCOMPLETE="off">
                                            <span class="input-group-addon"> 到 </span>
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    <label class="control-label col-md-4">持证种类</label>
                                    <div class="col-md-8">
                                        <input type="text" class="form-control" id="certificateCategory">
                                    </div>
                                </div>
                            </div>
                            <div class="col-md-4">
                                <div class="form-group">
                                    <label class="control-label col-md-4">员工状态，1在职，0离职</label>
                                    <div class="col-md-8">
...
<script>
    $(function() {
        ...
        $('#btnQuery').click(function(e) {
            ...
            var strEmployeeAge = $("#employeeAge").val();
            var strEmployeeBirthday = $("#employeeBirthday").val();
            var strEmployeeNumber = $("#employeeNumber").val();
            var strEmployeeDept = $("#employeeDept").val();
            var strEmployeeGender = $("#employeeGender").val();
            var strIdcard = $("#idcard").val();
            var strPhoneNumber = $("#phoneNumber").val();
            var strFirstWorkdate = $("#firstWorkdate").val();
            var strCertificateCategory = $("#certificateCategory").val();
            ...
            sUrl += 
                ...
                "&employeeAge=" + strEmployeeAge +
                "&employeeBirthday=" + strEmployeeBirthday +
                "&employeeNumber=" + strEmployeeNumber +
                "&employeeDept=" + strEmployeeDept +
                "&employeeGender=" + strEmployeeGender +
                "&idcard=" + strIdcard +
                "&phoneNumber=" + strPhoneNumber +
                "&firstWorkdate=" + strFirstWorkdate +
                "&certificateCategory=" + strCertificateCategory +
                "&employeeStatus=" + strEmployeeStatus +
                "&remark=" + strRemark +
                "&deleteFlag=" + strDeleteFlag +
                "&creator=" + strCreator +                //createDate=" + strCreateDate + 
