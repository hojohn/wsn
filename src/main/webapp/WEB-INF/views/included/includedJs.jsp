...
<script src="static/plugins/jquery-validation/js/additional-methods.js" type="text/javascript"></script>
...
<!-- <script src="static/plugins/stickup/stickUp.min.js" type="text/javascript"></script> -->
