...
<script>
    ...
    function getConfig() {
        return config = {
            ...
            },
            {
                ...
                "data": "deviceNumber",
                "render": function (data, type, full) {
                    return '<a href="javascript:;" onclick="showRepairContent(' + data + ')"><span class="label label-sm label-info"> 维修记录 </span></a>'+
                    '<a><span class="label label-sm label-warning">查看详情 </span> </a>';
                 }
            }
            ],
            "sScrollX": "2000px",
    ...
    function showRepairContent(_deviceNumber) {
        showModal(2, ' ', [ '1000px', '550px' ], "device/repair/" + _deviceNumber + "/pageList");
    }
</script>
</body>
</html>