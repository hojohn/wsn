        ...
        <div class="wrapper-content">
            <div class="portlet-title">
                <div class="caption font-dark">
                    <i class=" icon-layers font-green"></i> <span class="caption-subject bold uppercase"> 终端信息表 </span>
                    <c:if test="${hid ==1 }">
            ...
            <div class="portlet-body">
                <form action="device/terminal/update_page" class="form-horizontal" id="form-module">
                    ...
                    <div class="row border-txt">
                        ...
                        <div class="col-md-6">
                            <div class="form-group form-md-line-input">
                                <label class="col-md-4 control-label" for="form_control_1">
                                    连接移动节点<span class="required">*</span>
                                </label>
                                <div class="col-md-8">
                     ...
                     <div class="row border-txt">
                        <div class="col-md-12">
                            <div class="form-group form-md-line-input">
                                <label class="col-md-2 control-label" for="form_control_1">
                                    连接传感器<span class="required">*</span>
                                </label>
                                <div class="col-md-10">
