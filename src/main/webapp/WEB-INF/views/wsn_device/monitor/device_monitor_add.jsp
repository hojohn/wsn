                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group form-md-line-input">
                                        ...
                                        <div class="col-md-8">
                                            <input type="text" class="form-control" placeholder="格式：OBJ_C00_000" name="monitorObjId" id="monitorObjId">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group form-md-line-input">
                                        ...
                                        <div class="col-md-8">
                                            <input type="text" class="form-control" placeholder="" name="monitorObjName" id="monitorObjName">
                                            <div class="form-control-focus"></div>
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group form-md-line-input">
                                        ...
                                        <div class="col-md-8">
                                            <input type="text" class="form-control" placeholder="" name="monitorObjPlace" id="monitorObjPlace">
                                            <div class="form-control-focus"></div>
                                ...
                                <div class="col-md-6">
                                    <div class="form-group form-md-line-input">
                                        ...
                                        <div class="col-md-8">
                                           <!--  <input type="text" class="form-control" placeholder="" name="info1" id="info1"> -->
                                           <select name="info1" class="selectpicker form-control" id="info1">
                                            ...
                                            <div class="form-control-focus"></div>
                                            <span class="help-block">请输入监控类型</span>
                                        </div>
                                    </div>
                                </div>
                            </div>
                             ...
                             <!-- <div class="col-md-6">
                                ...
                                <div class="col-md-12">
                                    <div class="form-group form-md-line-input">
                                        ...
                                        <div class="col-md-10">
                                            <input type="text" class="form-control" placeholder="" name="monitorObjContent" id="monitorObjContent">
                                            <div class="form-control-focus"></div>
...
jQuery(document).ready(function() {
    ...
    //[2]表单校验初始化
    initFormValidate('form-add', rules, 'device/monitor/add', 'add');
