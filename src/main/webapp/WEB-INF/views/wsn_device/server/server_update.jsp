                ...
                <div class="wrapper-body">
                    <div class="portlet-title">
                        <div class="caption font-dark">
                            <i class="icon-layers font-green"></i> <span class="caption-subject bold uppercase">服务器修改</span>
                             <span class="dt-buttons">
                                <a class="dt-button btn yellow btn-outline btn-mnt" id="btnUpdate" href="device/info/update_page/server_page?id=${wsnHardwareInfo.wareId }&hid=0">
                                    <span>返回</span>
                                </a>
                             </span>
                        </div>
                                ...
                                <div class="col-md-6">
                                    <div class="form-group form-md-line-input">
                                        ...
                                        <div class="col-md-8">
                                            ...
                                            <select name="objId"  id="objId"  class="selectpicker show-tick form-control" multiple data-live-search="false">
                                                <option value="${wsnHardwareInfo.objId}" selected>${wsnHardwareInfo.objId}</option>
                                        ...
                                        <div class="col-md-8">
                                            <select id="usertype" name="infoOne" class="selectpicker show-tick form-control" multiple data-live-search="false">
                                                    ...
                                                    <c:forEach items="${temList }" var="tem">
                                                       <option value="${tem.wareId}" >${tem.wareId}</option>
                                                    </c:forEach>
                                            </select>
                                        </div>
                                    </div>
