        ...
        <div class="wrapper-content">
            <div class="portlet-title">
                <div class="caption font-dark">
                    <i class=" icon-layers font-green"></i> <span class="caption-subject bold uppercase"> 移动节点信息表 </span>
                        <c:if test="${hid ==1 }">
            ...
            <div class="portlet-body">
                <form action="device/move_node/update_page" class="form-horizontal" id="form-module">
