...
<link rel="shortcut icon" href="static/img/favicon.ico" />
    ...
    <body class=" login">
        <div class="logo">
             <img src="static/img/ak_logo.png" width="80" height="70"><h2>安 科 院</h2>
        </div>
        <div class="content">
            <form class="login-form" action="login" method="post">
                <div class="form-title">
                    <span class="form-title">欢迎登录</span> <!--物联网多源信息融合管理平台  -->
                    <span class="form-subtitle">物联网多源信息融合管理平台</span>
                </div>
                <div class="error-tip">
                    <span> ${error} </span>
                </div>
...
<!--             </form> -->
        ...
        <div class="copyright hide"> 2016 © CASST 运维管理平台 </div>
